...
user_input = "张鹏,马云,110101234567890123456788,男,女,其他,未公开,工程学士,华为,420281199323322214"
# 生成提示
...
model_name_or_path = "/Users/zhangpeng/bigmodel/Qwen-14B-Chat"
#chat_model = tongyi(model_name="Qwen-7B-chat", max_tokens=1000, model_name_or_path=model_name_or_path)

tonyi_model = Tongyi().load_model(path=model_name_or_path)

tonyi_model.invoke("What NFL team won the Super Bowl in the year Justin Bieber was born?")

# chat_model.load_model(model_name_or_path=model_name_or_path, device="mps")
